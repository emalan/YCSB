...
public class HazelcastClient extends DB {
	...
	private final static String clusterMembers = "";

	private final static String groupName = "";

	private final static String groupPassword = "";
  ...
  public void init() throws DBException {
    super.init();
    //hazelcastInstance = com.hazelcast.client.HazelcastClient.newHazelcastClient(clientConfig());
    hazelcastInstance = com.hazelcast.client.HazelcastClient.newHazelcastClient();
